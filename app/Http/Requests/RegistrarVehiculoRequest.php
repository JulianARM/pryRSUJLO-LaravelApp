...
class RegistrarVehiculoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'code' => ['required', 'string', 'max:30', 'unique:vehiculos,code'],
            'placa' => ['required', 'string', 'max:10', 'regex:/^([A-Z0-9]{3}\s?[A-Z0-9]{3}|[A-Z0-9]{2}-[A-Z0-9]{4}|[A-Z0-9]{3}-[A-Z0-9]{3})$/', 'unique:vehiculos,placa'],
